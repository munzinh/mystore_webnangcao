...
| brands | name, slug | Liên kết với product |
...
| Trang | Route | Chức năng |
|---|---|---|
| Thêm sản phẩm | `/seller` | Form đa bước, upload ảnh |
| Danh sách sản phẩm | `/seller/product-list` | Bảng, filter, edit/delete |
| Đơn hàng | `/seller/orders` | Quản lý tất cả đơn |
| Danh mục | `/seller/categories` | CRUD category cây |
| Thương hiệu | `/seller/brands` | CRUD brand |

### 6.3 Components nổi bật

- **ProductCard**: Hiển thị sản phẩm với giá gốc/khuyến mãi, rating, tồn kho.
- **ReviewSection**: Đánh giá đầy đủ với phân bổ sao, upload ảnh.
- **RecommendationSection**: Hiển thị gợi ý AI theo từng loại.
- **ProductForm**: Form tạo/sửa sản phẩm với variant matrix.
...
## PHẦN 9 – KẾ HOẠCH 5 TUẦN CÒN LẠI

### Tuần 1 (Tuần hiện tại)
- [ ] Kiểm tra và fix bugs còn tồn đọng
- [ ] Hoàn thiện UI trang chi tiết sản phẩm (variants, specs hiển thị đầy đủ)
- [ ] Test luồng thanh toán COD và Stripe end-to-end

### Tuần 2
- [ ] Nâng cấp Dashboard Seller: thêm thống kê doanh thu, biểu đồ
- [ ] Tích hợp trang tìm kiếm nâng cao với filter đa điều kiện
- [ ] Hoàn thiện hệ thống quản lý đơn hàng (seller cập nhật trạng thái)

### Tuần 3
- [ ] Chạy Python ML Service và test các thuật toán gợi ý
- [ ] Thu thập dữ liệu behavior, đánh giá Precision@K và Recall@K
- [ ] So sánh kết quả Content-based vs Collaborative vs Hybrid

### Tuần 4
- [ ] Tối ưu hiệu năng: lazy loading, caching, pagination
- [ ] Kiểm thử bảo mật (XSS, CSRF, injection)
- [ ] Responsive design hoàn chỉnh trên mobile
