...
| Danh sách sản phẩm | `/seller/product-list` | Bảng dữ liệu, filter, sort, thống kê nhanh, edit/delete |
...
- **ProductFilter**: Bộ lọc sản phẩm seller theo danh mục, trạng thái, sort.
