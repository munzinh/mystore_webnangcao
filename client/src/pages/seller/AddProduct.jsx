        ...
        <div className="flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <div className="flex flex-col gap-1 max-w-md">
                    ...
                    id="product-description" rows={4} className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40 resize-none" placeholder="Mô tả sản phẩm"></textarea>
                </div>
                <div className="w-full flex flex-col gap-1">
                    <label className="text-base font-medium" htmlFor="category">Loại</label>
                ...
                <div className="flex items-center gap-5 flex-wrap">
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        <label className="text-base font-medium" htmlFor="product-price">Giá sản phẩm</label>
                ...
                <button className="px-8 py-2.5 bg-[#d70018] text-white font-medium rounded cursor-pointer">Lưu</button>
            </form>
        </div>
    )
}
